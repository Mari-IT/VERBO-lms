...
import { ArrowLeftToLine, ListPlus} from "lucide-react";
    ...
    <div>
      <div className="flex items-center gap-5 mb-5">
        ...
        >
          ...
          <span>Back to Published Courses</span>
        </button>
      </div>
          ...
          <div className="flex justify-between md:flex-row flex-col gap-10 mt-5 font-dm-sans">
            <div className="basis-1/2">
              <div className="space-y-4">
                ...
                <CustomFormField
                  ...
                  options={[
                    { value: "English Language Learning", label: "English" },
                    { value: "Polish Language Learning", label: "Polish" },
                    { value: "German Language Learning", label: "German" },
                    { value: "Spanish Language Learning", label: "Spanish" },
                  ]}
            ...
            <div className="bg-customgreys-darkGrey mt-4 md:mt-0 p-4 rounded-lg basis-1/2">
              <div className="flex justify-between items-center mb-2">
                ...
                >
                  <ListPlus className="mr-1 h-4 w-4 text-primary-700 group-hover:white-100" />
              ...
              {isLoading ? (
                ...
                <p>Sections will appear here once added</p>
              )}
            </div>
          </div>
        </form>
